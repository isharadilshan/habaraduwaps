					...
					<div class="blog-content blog-detail">
						<div class="blog-post">
							<div class="entry-thubmnail">
								<img class="img-responsive" src="{{ asset('images/cars/front/' .$cars->image) }}" alt="" />
							</div>
								...
								<div class="row">
									<div class="col-md-4">
										<div class="seller-image">
											<a href="{{ route('cars',$recent->slug) }}"><img class="img-responsive" src="{{  asset('images/cars/front/' .$recent->image2) }}" alt="seller"></a>
										</div>
									</div>
									<div class="col-md-8">
