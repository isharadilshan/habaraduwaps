        ...
        <div class="container">
            <div class="contact-us">
                ...
                <div class="contact-form-wrapper">
                    ...
                    <form id="contact-form" class="contact-form" name="contact-form" method="POSt" action="{{ route('contact.send') }}">
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col-sm-6">
                ...
                <div class="map-wrapper">
                    ...
                    <script>
                        ...
                        function initMap() {
                          // The location of Habaraduwa Pradeshiya Sabawa
                          var habaraduwaps = {lat: 5.9939387, lng: 80.3057366    };
                          // The map, centered at Habaraduwa Pradeshiya Sabawa
                          var map = new google.maps.Map(
                              document.getElementById('map'), {zoom: 15, center: habaraduwaps});
                          // The marker, positioned at Habaraduwa Pradeshiya Sabawa
                          var marker = new google.maps.Marker({position: habaraduwaps, map: map});
                        }
                    </script>
